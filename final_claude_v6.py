...
# --- RADIAL PROFILE: bat loi thieu nhua CUC BO ---
RADIAL_BINS = 72                # Do phan giai goc: 360/72 = 5 do/lat
RADIAL_MIN_STD = 0.012          # San toi thieu cho std tung lat
RADIAL_Z_THRESHOLD = 4.0        # Lat bi coi la "hut" neu ban kinh ngan hon chuan > nguong nay
RADIAL_MIN_CONSEC_BINS = 3      # Phai co >=3 lat LIEN TIEP hut moi tinh la loi that
RADIAL_MAX_PHASE_SHIFT = 4      # So lat (~20 do) cho phep do tim lai goc xoay chinh xac hon

# Khong gian chuan (neu can dung golden mask - hien tai chua dung)
...
def extract_main_contour(roi_bgr):
    ...
    # QUAN TRONG: RETR_CCOMP de giu lai cac lo ben trong
...
# ============================================================
# RADIAL PROFILE - chi de dinh vi loi cuc bo
# ============================================================
def rotate_contour_upright(contour):
    """Xoay contour ve mot goc chuan (khong warp anh, chi xoay toa do)."""
...
def get_radial_profile(rotated_contour, n_bins=RADIAL_BINS):
    """Tra ve mang [n_bins] la ban kinh (da chuan hoa theo kich thuoc) tu tam ra bien."""
    ...
    # Chuan hoa ty le theo convex hull
...
def align_profile_phase(test_profile, ref_profile, max_shift=RADIAL_MAX_PHASE_SHIFT):
    """Tim do lech goc xoay con sot lai bang cach thu dich vong."""
...
def get_shape_features(contour):
    # Lam min contour 1 lan de giam rang cua
...
# ============================================================
# BUOC 4: GIAO DIEN VA LOGIC CHINH
# ============================================================
BG_DARK = "#3c3f41"
BG_PANEL = "#e8e8e8"
BG_IMAGE = "#4a4a4a"
